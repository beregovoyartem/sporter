...
TOP_CLUBS = {
    ...
    # ── ЗБІРНІ (Рейтинг ФІФА / ЧС) ──────────────────────────────────────────
    # ★★★★★
    "аргентина": 5, "франция": 5, "франція": 5, "англия": 5, "англія": 5,
    "бразилия": 5, "бразилія": 5, "испания": 5, "іспанія": 5,
    "португалия": 5, "португалія": 5, "нидерланды": 5, "нідерланди": 5,
    # ★★★★
    "италия": 4, "італія": 4, "хорватия": 4, "хорватія": 4,
    "бельгия": 4, "бельгія": 4, "германия": 4, "німеччина": 4,
    "уругвай": 4, "колумбия": 4, "колумбія": 4, "сша": 4, "мексика": 4,
    # ★★★
    "швейцария": 3, "швейцарія": 3, "сенегал": 3, "япония": 3, "японія": 3,
    "марокко": 3, "дания": 3, "данія": 3, "австрия": 3, "австрія": 3,
    "украина": 3, "україна": 3, "эквадор": 3, "еквадор": 3,
    # ★★
    "турция": 2, "туреччина": 2, "австралия": 2, "австралія": 2,
    "сербия": 2, "сербія": 2, "польша": 2, "польща": 2,
    "южная корея": 2, "південна корея": 2, "республика корея": 2,
    "уэльс": 2, "уельс": 2, "иран": 2, "іран": 2, "швеция": 2, "швеція": 2,
    # ★
    "канада": 1, "камерун": 1, "гана": 1, "саудовская аравия": 1,
    "коста-рика": 1, "перу": 1, "чили": 1, "чилі": 1,
    "чехия": 1, "чехія": 1, "венгрия": 1, "угорщина": 1,
}
...
UKR_BOOST_LEAGUES = {
    ...
    "Лига наций", "Евро квал.", "ЧМ квал.", "Чемпионат Мира",
...
LEAGUE_MAP = [
    ...
    (["чемпионат мира (ж)", "чемпионат мира. женщины", "world cup (w)", "women's world cup"], "Чемпионат Мира (Ж)"),
    (["квалификация чм", "wc qualif", "чемпионат мира", "world cup", "чм. квалификация", "чм квал", "чм-квал", "чм квал."], "Чемпионат Мира"),
...
PRIORITY_LEAGUES = {
    ...
    "Юнош. лига УЕФА","Кубок Украины","Лига наций","Эредивизи","Чемпионат Мира","Чемпионат Мира (Ж)",
...
FLAG_MAP = {
    ...
    "Лига наций": "eu", "Евро квал.": "eu", "ЧМ квал.": "eu", "Чемпионат Мира": "eu", "Чемпионат Мира (Ж)": "eu",
    "Юнош. лига УЕФА": "eu",
...
LEAGUE_POP = {
    ...
    'Лига наций': 14, 'Евро квал.': 15, 'ЧМ квал.': 16, 'Чемпионат Мира': 3, 'Чемпионат Мира (Ж)': 3,
    'Юнош. лига УЕФА': 17,
